...
#Date:-16/07/2013
#This code is to separate the appendexb into two excel file and edit the first excel file.
import pandas as pd
...
df.to_excel("dbappendexb.xlsx", index=False)
...
df.to_excel("dbappendexb.xlsx", index=False)
df=pd.read_excel("dbappendexb.xlsx")
...
print b
df = pd.DataFrame(b)
writer = ExcelWriter('(final)appendixb.xlsx', engine='xlsxwriter')
